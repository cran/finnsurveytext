...
|:---:|---|---|
| **1. Data Preparation** | use the `udpipe` `R` package to clean and annotate the raw data into a standardised format (CoNLL-U) suitable for analysis. | fst_format()<br>fst_print_available_models()<br>fst_find_stopwords()<br>fst_rm_stop_punct()<br>**fst_prepare()**<br>**fst_prepare_svydesign()** |
