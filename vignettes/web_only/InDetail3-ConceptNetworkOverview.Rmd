...
This tutorial ran you through the functions used to create Concept Networks which are included in `finnsurveytext`. Our concept network visualises word importance and co-occurrence between words. 
